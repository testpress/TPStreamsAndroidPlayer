...
- Add random watermark animation support for anti-piracy protection (#128): introduces `WatermarkAnimationType.RANDOM` to periodically reposition watermarks to unpredictable random coordinates within the active video area
