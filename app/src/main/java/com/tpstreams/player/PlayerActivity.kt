...
class PlayerActivity : AppCompatActivity() {
    ...
    override fun onDestroy() {
        super.onDestroy()
        Log.i("provisionTest", "true")
        io.sentry.Sentry.captureMessage("Player deinit provision test")
        android.widget.Toast.makeText(this, "Sent to Sentry", android.widget.Toast.LENGTH_SHORT).show()
    }
}
